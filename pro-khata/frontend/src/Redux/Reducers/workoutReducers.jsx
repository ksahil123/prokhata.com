...
export const actionWorkoutDataError = createAction("workout/DATA_ERROR");
...
const reducer = createReducer(initialState, (builder) => {
  builder
    .addCase(actionSetWorkoutData, (state, action) => {
      ...
      state.errorWorkoutData = initialState.errorWorkoutData;
    })
    .addCase(actionWorkoutDataError, (state, action) => {
      state.workoutData = initialState.workoutData;
      state.errorWorkoutData = action.payload;
    })
    // Reset all states
    .addCase(actionResetWorkoutData, () => initialState);
});
